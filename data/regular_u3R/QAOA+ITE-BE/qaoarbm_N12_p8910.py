...
approx_name = 'qaoarbm_appro_N' + node + '_p8910' + '_' + str(start_from)
overlap_name = 'qaoarbm_overlap_N' + node + '_p8910' + '_' + str(start_from)
postselect_name = 'qaoarbm_postselect_N' + node + '_p8910' + '_' + str(start_from)
result_name = 'qaoarbm_result_N' + node + '_p8910' + '_' + str(start_from)
